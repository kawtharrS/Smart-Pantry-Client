const Guide = () => {
  return (
    <div className="relative flex h-11/12 w-full mt-8 overflow-hidden z-0 justify-center items-center">

      <div className="w-2 font-black text-black z-10 pl-15 ">
        <h1>Your Guide</h1>
      </div>
      ...
      <div className="flex justify-end w-full">
        ...
        <div className="rounded-l-full bg-amber-500 w-3/4 h-80 p-10 
                        flex flex-col justify-center mb-50">
